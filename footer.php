...
?>
	...
	<footer id="contact" class="vetra-footer">
		<div class="vetra-container">
			...
			<?php if ( vetra_option( 'footer_bottom_enabled', true ) ) : ?><div class="vetra-footer__bottom"><span>© <?php echo esc_html( gmdate( 'Y' ) ); ?> گروه ساختمانی و مهندسی وترا</span><span>ساخته‌شده برای ماندگاری</span></div><?php endif; ?>
		</div>
	</footer>
	<?php endif; ?>
</div>

...
<section class="vetra-hero vetra-container vetra-reveal">
	<div class="vetra-hero__copy">
		<span class="vetra-kicker"><i></i><?php echo esc_html( vetra_option( 'hero_eyebrow' ) ); ?></span>
		<h1><?php echo wp_kses_post( nl2br( esc_html( vetra_option( 'hero_title' ) ) ) ); ?></h1>
		...
		<div class="vetra-hero__signature"><span class="vetra-avatars"><i></i><i></i><i></i></span><span><strong>همراه پروژه‌های ماندگار</strong><small>از ایده تا تحویل نهایی</small></span></div>
	</div>
...
<section class="vetra-stat-strip vetra-container vetra-reveal" aria-label="آمار وترا">
...
<section id="services" class="vetra-section vetra-container vetra-reveal">
	<div class="vetra-section-heading"><div><span class="vetra-kicker"><i></i>توانمندی‌های ما</span><h2><?php echo esc_html( vetra_option( 'services_title' ) ); ?></h2></div><p><?php echo esc_html( vetra_option( 'services_intro' ) ); ?></p></div>
	<div class="vetra-service-grid">
		<?php $service_icons = array( 'pen', 'chart', 'building' ); for ( $i = 1; $i <= 3; $i++ ) : ?><article class="vetra-service-card"><span class="vetra-service-card__number">۰<?php echo esc_html( $i ); ?></span><span class="vetra-service-card__icon"><?php echo vetra_inline_icon( $service_icons[ $i - 1 ] ); ?></span><h3><?php echo esc_html( vetra_option( 'service_' . $i . '_title' ) ); ?></h3><p><?php echo esc_html( vetra_option( 'service_' . $i . '_text' ) ); ?></p><a href="#contact" aria-label="<?php echo esc_attr( vetra_option( 'service_' . $i . '_title' ) ); ?>">بیشتر بدانید <span><?php echo vetra_inline_icon( 'arrow' ); ?></span></a></article><?php endfor; ?>
	</div>
</section>
<?php endif; ?>
